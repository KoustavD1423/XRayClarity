...
if __name__ == '__main__':
    ...
    path = {
        'vgg16': 'M:\\Projects\\machineLearning\\xrays-and-gradcam-master\\models\\lr3e-5_vgg_cuda.pth',
        'resnet18': 'M:\\Projects\\machineLearning\\xrays-and-gradcam-master\\models\\lr3e-5_resnet_cuda.pth',
        'densenet121': 'M:\\Projects\\machineLearning\\xrays-and-gradcam-master\\models\\lr3e-5_densenet_cuda.pth'
    }
    ...
    model = eval(
        f'networks.get_{args.model}(out_features=4, path=r"{path}")'
    ).cpu()
